...
The analysis will be done for employees and teams separately and aggregated
independently. Employees will be categorized. Also, team members will be defined as belonging to a team based on supervisor. These teams will also be
categorized. The table below defines how we plan to aggregate for staff
and teams.
...
# CONTINUE REVIEWING TERMS FROM HERE.
...
We will categorize employees and teams in two ways. First,
rules-based groups will be formed. For these, definitions of different
types of work will be defined based on the proportion of work done remotely, by policy rules, and by position category. Second, groups will be formed using
...
For staff-level analysis, the team will be defined by the employee's
supervisor. Changes in supervisors will come from staff moving teams or
an existing team changing supervisors. The size of the team will be
calculated with the mode of staff with the supervisor over the
...
identifier for teams will be the `supervisor_e_mail_address`. All
employees under those supervisors will be defined as part of the team.
Employees may join and leave a team over the observation window.
...
5.  **Onsite Required** - Defined by `position_category_description` in
    the roster data
6.  **Primarily remote** - Staff who work remotely above the 95th
    percentile <!-- could be 75th -->
7.  **Mostly remote** - Staff who work remotely between the median and
    the 95th percentile <!-- could be 75th -->
8.  **Mostly onsite** - Staff who work remotely between 5th percentile
    and the median <!-- could be 25th -->
9.  **Primarily onsite** - Staff who work remotely below the 5th
    percentile <!-- could be 75th -->
...
4.  **Offsite** - All team members are *Offsite* as defined by
    `position_category_description` in the roster data
