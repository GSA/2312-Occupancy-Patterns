...
<!-- [We currently have Nov 2022 and Dec 2022 updates; I will try to track down -->
...
Another set of statistics will be designed to understand the relationship between staff work patterns and their supervisor. We will calculate  the proportion of the staff that fall into the same rule-based and clusters as their supervisors overall as well as by those categories. 

These statistics will be presented in tables. Visualizations will be created for a subset to help communicated results. Charts of the work pattern data will be created to confirm and characterize the groupings. In addition, charts showing difference by stated telework position category.  
