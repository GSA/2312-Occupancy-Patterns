...
independently. Employees will be categorized. Also, employees with be
grouped into teams based on supervisor. These teams will also be
...
caluculated with the mode of staff with the supervisor over the
...
3.  **Primarily remote** - Staff who work remotely above the 95th
    percentile <!-- could be 75th -->
4.  **Mostly remote** - Staff who work remotely between the median and
    the 95th percentile <!-- could be 75th -->
5.  **Mostly onsite** - Staff who work remotely between 5th percentile
    and the median <!-- could be 25th -->
6.  **Primarly onsite** - Staff who work remotely below the 5th
    percentile <!-- could be 75th -->

Teams will be categorized similarly:

1.  **Primarily remote** - Teams that work remotely above the 95th
    percentile <!-- could be 75th -->
...
3.  **Mostly onsite** - Teams that work remotely between 5th percentile
    and the median <!-- could be 25th -->
4.  **Primarily onsite** - Teams that work remotely below the 5th
    percentile <!-- could be 75th -->
