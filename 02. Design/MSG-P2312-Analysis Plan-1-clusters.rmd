...
patterns and descriptive data. The initial condition of descriptive variables will be used to calculate the statistics. That is, the values of these variables for employees and teams at the beginning of the observation window: March 2022.
