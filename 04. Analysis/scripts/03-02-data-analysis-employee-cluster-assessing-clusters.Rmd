...
Generates 1 to 10 new clusters for specifications and creates elbow charts for each specification.
...
Generates 1 to 10 new clusters for specifications and creates average silhouette charts for each specification.
...
Generates 1 to 10 new clusters for specifications and creates gap statistic charts for each specification.
