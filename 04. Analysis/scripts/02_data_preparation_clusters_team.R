...
file_name <- glue::glue("02-data_preparation-clusters-team-{project_number}-{str_replace_all(str_to_lower(project_name),' ','-')}-{today()}.html")
...
rmarkdown::render(input = here::here("04. Analysis",
                                     "scripts",
                                     "02_data_preparation_clusters_team.Rmd"),
                  params = list(
                    author = author,
